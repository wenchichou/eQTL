...
for(CHR in seq(1,22,1)){
  bagSNP.CHR.path <- paste(dirBagging,"bagSNP_chr",CHR,"_CHRPOS.gz",sep="")
...
GWAS <- read.table(GWASfilePath, header=F)  ## All GWAS header set to FALSE
